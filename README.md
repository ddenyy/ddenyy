...
### ***О себе:***
* 🌶️ студент математического факультета / мыслю структурировано

* ⭐ знаю алгоритмы и умею оценивать их сложность / занимаюсь спортивным программированием на С++ / python
  
* ⏱ Учусь оптимизировать производительность 
